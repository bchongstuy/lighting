...
def calculate_diffuse(light, dreflect, normal):
  direction = dot_product(light[0], normal)
  return [dreflect[0] * direction * light[1][0],
          dreflect[1] * direction * light[1][1],
          dreflect[2] * direction * light[1][2]]
...
def calculate_specular(light, sreflect, view, normal):
  ...
  cosAlpha = dot_product(view, r)
  if cosAlpha < 0:
    cosAlpha = -1 * (cosAlpha ** SPECULAR_EXP)
  else:
    cosAlpha ** SPECULAR_EXP
  return [sreflect[0] * light[1][0] * cosAlpha,
          sreflect[1] * light[1][1] * cosAlpha,
          sreflect[2] * light[1][2] * cosAlpha]
